 ...
 *  @author Kevin Wayne
 */
public final class window implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static window std = new window();
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = window.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (filename != null) {
            window.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = window.userX(e.getX());
            mouseY = window.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    ***************************************************************************/
     ...
     */
    public static void main(String[] args) {
        window.square(0.2, 0.8, 0.1);
        window.filledSquare(0.8, 0.8, 0.2);
        window.circle(0.8, 0.2, 0.2);

        window.setPenColor(window.BOOK_RED);
        window.setPenRadius(0.02);
        window.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        window.setPenRadius();
        window.setPenColor(window.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        window.filledPolygon(x, y);

        // text
        window.setPenColor(window.BLACK);
        window.text(0.2, 0.5, "black text");
        window.setPenColor(window.WHITE);
        window.text(0.8, 0.8, "white text");
    }
